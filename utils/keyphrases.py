diagnostic_keyphrases = {
  ...
  'severe proliferative diabetic retinopathy', 'myopia retinopathy',
  ...
  5: ['hypertensive', 'hypertensive retinopathy'],
...
diagnostic_normale_or_not = {
  ...
  'suspicious diabetic retinopathy', 'suspected diabetic retinopathy', 'myopic retinopathy',
  'glaucoma', 'suspected glaucoma', 'severe nonproliferative retinopathy',
  'proliferative diabetic retinopathy', 'suspected moderate non proliferative retinopathy','cataract',
  'age-related macular degeneration', 'wet age-related macular degeneration',
  'dry age-related macular degeneration','hypertensive','myopi', 'pathological myopia',
  'macular epiretinal membrane', 'epiretinal membrane', 'drusen','myelinated nerve fibers',
  'vitreous degeneration', 'refractive media opacity', 'spotted membranous change', 'tessellated fundus', 
  'maculopathy',
  'chorioretinal atrophy',
  'branch retinal vein occlusion',
  'retinal pigmentation',
